/**
 * Upanishads Metadata
 * Lightweight metadata for list pages - no content imports
 * This file should be imported by pages that only need summaries/metadata
 */
...
// Re-export types and helper functions from types.ts
export * from './types';
...
// =============================================================================
// HELPER FUNCTIONS (metadata-only, no content needed)
// =============================================================================
